...
def build_region_extractor(
    ...
    if config.resume_path and os.path.exists(model_type_or_path):
        ...
        return RegionExtractor.from_pretrained(
        ...
        region_extractor = RegionExtractor(region_extractor_cfg, config).to(
...
class RegionExtractor(PreTrainedModel):
    ...
    def __init__(
        self, region_extractor_cfg: RegionExtractorConfig, config: PretrainedConfig
    ):
